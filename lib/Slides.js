...
var Track = function (_Component) {
  ...
  _createClass(Track, [{
    ...
    value: function computeTrackStyle() {
      ...
      var trackTransition = infinite === true && (previousSlide === -1 && currentSlide === slideCount - 1 || previousSlide === slideCount && currentSlide === 0) || translateXOffset !== 0 || translateYOffset !== 0 ? '' : '-moz-transform ' + transitionSpeed + 'ms ' + transitionTimingFn;
